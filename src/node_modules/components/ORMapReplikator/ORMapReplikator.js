...
const {createORMap, streamIntoIdentity, associate} = ORMap;
...
class ORMapReplikator extends Component {
  constructor(props) {
    super(props);
      const {userId, ormapId, uri, evalFunctions, atom} = props;
    const wrappedEvalFunctions = wrapEvalFunctions(evalFunctions, this);
      const replica = createReplica(atom, userId, ormapId, uri, wrappedEvalFunctions);
